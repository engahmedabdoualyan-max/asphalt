...
const en: Dict = {
  ...
  prodTitle: "🏭 Production Control", prodStartBatch: "▶ Produce", prodStopPlant: "⏸ Stop",
  ...
  fleetTitle: "🚛 Fleet Management", fleetAddTruck: "+ Add Truck", fleetTruckNo: "Truck #",
...
const ar: Dict = {
  ...
  prodTitle: "🏭 التحكم في الإنتاج", prodStartBatch: "▶ إنتاج باتشة", prodStopPlant: "⏸ إيقاف",
  ...
  fleetTitle: "🚛 إدارة الأسطول", fleetAddTruck: "+ إضافة سيارة", fleetTruckNo: "رقم السيارة",
...
const ur: Dict = {
  ...
  prodTitle: "🏭 پروڈکشن کنٹرول", prodStartBatch: "▶ بیچ بنائیں", prodStopPlant: "⏸ روکیں",
